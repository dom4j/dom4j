...
public class PerfDOM4J
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            PerfDOM4J.parse(numrec);
			PerfDOM4J.transform(doc,"item.xslt",10);
            PerfDOM4J.xpath(doc,"/*/*/Attr1x5",100);
            PerfDOM4J.xpathNodes(doc,"/*/*/Attr1x1",100);
            PerfDOM4J.xpathNodes(doc,"/*/*/Attr1x5",100);
            PerfDOM4J.xpathNodes(doc,"/*/*/Attr1x9",100);
            PerfDOM4J.xpathNodes(doc,"/*/Item",100);
            ...
            PerfDOM4J.parse(numrec);
            PerfDOM4J.transform(doc,"item.xslt",10);
			PerfDOM4J.xpath(doc,"/*/*/Attr1x1",100);
            PerfDOM4J.xpathNodes(doc,"/*/*/Attr1x1",100);
            PerfDOM4J.xpathNodes(doc,"/*/Item",100);
