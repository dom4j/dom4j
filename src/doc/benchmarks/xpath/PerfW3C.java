...
public class PerfW3C
{
	...
	for (int kk = 0 ; kk < pp ; kk++) {
        ...
        for (int ii=0;ii<iNumRecs;ii++)
        {
            ...
            {
               /*
                AttrImpl a = (AttrImpl)document.createAttribute("Attr"+jj);
                a.setNodeValue("123456789");
                Record.setAttributeNode(a);
               */
                Element field= document.createElement( "Attr" +  jj +"x" + ii );
    ...
    public static void xpathNodes(Document document, String xpathExp, int pp)
    {
        ...
        System.err.println("W3C xpathNodes  time :"  + 1.000*(end-start)/pp );
    }
